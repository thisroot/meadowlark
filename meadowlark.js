...
// This seeds the Mongo DB based on the Mongoose schema
Vacation.find(function(err, vacations){
  ...
  new Vacation({
    ...
    category: 'Day Trip',
    sku: 'HR199',
    description: 'Spend the day sailing on the Columbia and ' +
      'enjoying the Hood River',
    priceInCents: 9995,
  ...
  new Vacation({
    ...
    maximumGuests: 4,
    available: true,
    notes: 'The tour guide is currently recovering from a skiinig accident',
    packagesSold: 0
  }).save();
